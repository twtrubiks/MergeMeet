...
| **版本** | 1.0.0 MVP |
| **開發進度** | ✅ Week 1-6 已完成 |
| **代碼規模** | 約 41,000 行（後端 11,342 + 前端 20,229 + 測試 9,487） |
...
| API 文檔 (ReDoc) | http://localhost:8000/redoc | REST API 閱讀式文檔 |
| GraphQL Playground | http://localhost:8000/graphql | GraphQL 查詢介面 |
