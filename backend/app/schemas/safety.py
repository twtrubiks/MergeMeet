...
class BlockUserRequest(BaseModel):
    ...
    reason: str | None = Field(None, max_length=500, description="封鎖原因")
...
class ReportUserRequest(BaseModel):
    ...
    evidence: str | None = Field(None, max_length=2000, description="證據說明")
    ...
    def validate_uuid(cls, v: str) -> str:
        ...
        try:
            ...
            raise ValueError("無效的用戶 ID 格式") from e
        return v
